---
title: 'My Journey of becoming a computer scientist'
date: '2023-12-19'
tags: ['open source']
draft: false
summary: It has a been a tough journey so far for me going through 9 courses on the Georgia Tech MAsters program on Computer Science.
Over a couple of years, I have taken 9 courses including sofftware Analysis and Design, Database Systems, General computer security and Security related to Cyberphysical Systems.
I have also taken courses in Machine Learning theory and application (Machine learning of trading), Deep learning Health informatics and AI Ethics.

images: ['/static/images/banners/open-sourcing.png']
---

It has a been a tough journey so far for me going through 9 courses on the Georgia Tech MAsters program on Computer Science.
Over a couple of years, I have taken 9 courses including sofftware Analysis and Design, Database Systems, General computer security and Security related to Cyberphysical Systems.
I have also taken courses in Machine Learning theory and application (Machine learning of trading), Deep learning Health informatics and AI Ethics.

I am happy that I took the decision to apply for the online master of science course with Georgia Tech just before Covid hit.

That gave me an a good hit of motivation that jump-started me into the program. Beginning with the 


ntribution at my job early on. While I was working on a R&D project to convert a video game engine from C++ to WebGL in 2011, I was using an open source tool to automate that process. I was building a prototype and hit a bug. By looking at the source code, I was able to pinpoint the issue, opened a pull request and it was swiftly merged into the library.
